 ...
 * @param {Object} props
 * @param {string} props.type - Loại thông báo: 'success', 'info', 'warning', 'error'
 * @param {string} props.message - Nội dung thông báo
 * @param {boolean} props.dismissible - Có thể đóng thông báo
 * @param {Function} props.onDismiss - Callback khi đóng thông báo
 */
const Alert = ({ 
  type = 'info', 
  message, 
  ...
  return (
    <div className={`border-l-4 p-4 mb-4 ${alertClasses[type]} ${className}`} role="alert">
            ...
            <div className="-mx-1.5 -my-1.5">
              <button
                ...
                className={`inline-flex p-1.5 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  ...
                  'focus:ring-blue-400 hover:bg-blue-100'
                }`}
              >
